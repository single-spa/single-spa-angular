...
export class SingleSpaBrowserBuilder extends BrowserBuilder {
  ...
  buildWebpackConfig(
    ...
    const libraryName = options.libraryName || this.getProjectName();
  ...
  private getProjectName() {
    if (this.context.targetSpecifier && this.context.targetSpecifier.project) {
      return camelize(this.context.targetSpecifier.project);
    }
  }
}
