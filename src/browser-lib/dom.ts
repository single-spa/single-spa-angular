...
export function ivyEnabled(): boolean {
  try {
...
export function removeApplicationFromDOMIfIvyEnabled(opts, props): void {
...
export function chooseDomElementGetter(opts, props): DomElementGetter {
